...
def area_cal(x, y, r, d1, d2):
    ...
    dec_cal = (10 * a**2) / (4 * math.tan(math.pi / 10))
    
    return reg_cal, tri_cal, cir_cal, sem_cal, squ_cal, rho_cal, pen_cal, hex_cal, oct_cal, dec_cal


reg, tri, cir, sem, squ, rho, pen, hex, oct, dec = area_cal(6, 4, 3)
...
print(f'หาพื้นที่รูปสิบเหลี่ยม = {dec}')